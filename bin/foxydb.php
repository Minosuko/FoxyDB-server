...
$options = getopt('', ['host:', 'port:', 'data-dir:', 'no-sync', 'plaintext', 'help']);
...
Environment variables:
  ...
  FOXYDB_MAX_MATERIALIZED_BYTES, FOXYDB_IDLE_TIMEOUT
  FOXYDB_MAX_CONNECTIONS, FOXYDB_MAX_TRANSFERS, FOXYDB_MAX_GLOBAL_TRANSFERS
  FOXYDB_MAX_UPLOAD_BYTES, FOXYDB_SYNC_WRITES, FOXYDB_TLS
...
try {
    ...
    $requiredExtensions = ['json', 'mbstring', 'zlib'];
    if ($config->tlsEnabled && !isset($options['plaintext'])) {
